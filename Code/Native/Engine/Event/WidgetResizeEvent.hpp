// File /Native/Engine/Event/WidgetResizeEvent.hpp
//
...
namespace PenEngine
{
    class WidgetResizeEvent : public IEngineEvent
    {
    public:
        WidgetResizeEvent() noexcept : IEngineEvent(PredefinedEngineEventType::WindowResize) {}
        WidgetResizeEvent(U32 width, U32 height, U32 oldWidth, U32 oldHeight) noexcept
        ...
        virtual ~WidgetResizeEvent() noexcept override = default;
